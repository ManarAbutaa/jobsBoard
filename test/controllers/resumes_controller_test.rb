...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference("Resume.count") do
      post resumes_url, params: { resume: { cover_letter: @resume.cover_letter, title: @resume.title } }
    end
  ...
  test "should update resume" do
    patch resume_url(@resume), params: { resume: { cover_letter: @resume.cover_letter, title: @resume.title } }
